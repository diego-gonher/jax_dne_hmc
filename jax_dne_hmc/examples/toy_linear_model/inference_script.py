####################################################################################################
#
# Example of using trained emulators to perform parameter inference using HMC.
#
####################################################################################################
...
mean_emulator = MeanEmulator.load_model(checkpoint_dir=mean_best_model_directory,
                                        X_train=X_train,
...
covar_emulator = CovarEmulator.load_model(checkpoint_dir=covar_best_model_directory,
                                          X_train=X_train,
